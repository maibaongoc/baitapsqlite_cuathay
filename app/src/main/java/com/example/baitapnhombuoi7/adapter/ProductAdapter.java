package com.example.baitapnhombuoi7.adapter;
...
import com.example.baitapnhombuoi7.R;
...
@Override
public void onBindViewHolder(@NonNull ProductAdapter.ViewHolder holder,
        int position) {
        ...
        int imageID= context.getResources().getIdentifier(temp.getImage(), "drawable", context.getPackageName());
        if (imageID!=0){
